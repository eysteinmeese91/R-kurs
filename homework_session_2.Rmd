...
# JP:
# Veldig mye bra her! Se enkelte kommentarer under, markert med "JP". Håper de
# er nyttige for deg :-)

# JP:
# Kommentar til bruk av github: 
# Flott at du har committet underveis! Les gjerne slidene fra sesjon 2 om å 
# skrive gode commit messages, siden du bruker dette en del på prosjekt. 
...
# JP:
# Fin funksjon og fin feilmelding! Ofte kan det være lurt å bruke "is.numeric" 
# fremfor "is.integer" eller "is.double" fordi den er mindre streng. Denne funksjonen
# hadde funket helt fint på både integers og doubles.
...
# JP:
# Nydelig svar! Mange som misset på denne. 
...
# JP:
# Fin funksjon! Se løsningsforslag for en vektorisert versjon også. 
# PS: jeg ser at du bruker "else { if(){..} }", men det holder å skrive 
# "else if() {...} ". Da får man litt renere og penere kode. 
...
# JP:
# Tror du mener den siste ser feil ut fordi den returnerer to tall. 
# "Problemet" er at du har spesifisert "print" i begge funksjonene. Dermed vil 
# celsius_to_fahrenheit(23) printe 73 før fahrenheit_to_celsius() printer 23.
...
# JP:
# Fin funksjon, men usikker på om "print" på slutten tilfører noe verdi. Kommer
# som alltid an på hvordan man planlegger å bruke funksjonen. 
...
# JP:
# Veldig bra! 
# Tips: Dersom du hadde droppet å assigne til pros_na kunne du også 
# sløyfet "return()", og hele funksjonen hadde blitt kortere og kanskje mer lettlest
...
# JP:
# Jeg husker du hadde trøbbel med denne, og nå ser jeg hvorfor. I "regexp" bruker du 
# "\\~csv$", men det skal være \\.csv$" ("." istedenfor "~").
# Tips: Dersom du ville hatt .Rmd-filen i mappen "Del_2" 
# slik du hadde tidligere så måtte du ha endret path til:
# "./../Data/Karakterer_per_fylke"
...
# JP:
# Bra, men tror jeg ville droppet "print" i første funknsjonen. Nå printer den 
# alle transformasjonene før den lager plottet. 
